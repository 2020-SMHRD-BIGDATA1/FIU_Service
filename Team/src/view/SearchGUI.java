...
public class SearchGUI {
	...
	private void initialize() {
		...
		btn_back.setIcon(new ImageIcon("C:\\Users\\SMHRD\\Desktop\\\uC774\uBBF8\uC9C0\\btn_back.png"));
		...
		btn_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				...
				map_panel.setPath("C:\\Users\\SMHRD\\Desktop\\이미지\\지도\\서울.PNG");
				map_panel.repaint();
		...
		btn_2.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				map_panel.setVisible(false);
				map_panel.setPath("C:\\Users\\SMHRD\\Desktop\\이미지\\지도\\경기.PNG");
				map_panel.repaint();
				map_panel.setVisible(true);
			}
		...
		btn_3.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				map_panel.setVisible(false);
				map_panel.setPath("C:\\Users\\SMHRD\\Desktop\\이미지\\지도\\인천.PNG");
				map_panel.repaint();
				map_panel.setVisible(true);
			}
		...
		btn_4.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				map_panel.setVisible(false);
				map_panel.setPath("C:\\Users\\SMHRD\\Desktop\\이미지\\지도\\세종.PNG");
				map_panel.repaint();
				map_panel.setVisible(true);
			}
		...
		btn_5.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				map_panel.setVisible(false);
				map_panel.setPath("C:\\Users\\SMHRD\\Desktop\\이미지\\지도\\대전.PNG");
				map_panel.repaint();
				map_panel.setVisible(true);
			}
		...
		btn_6.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				map_panel.setVisible(false);
				map_panel.setPath("C:\\Users\\SMHRD\\Desktop\\이미지\\지도\\대구.PNG");
				map_panel.repaint();
				map_panel.setVisible(true);
			}
		...
		btn_7.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				map_panel.setVisible(false);
				map_panel.setPath("C:\\Users\\SMHRD\\Desktop\\이미지\\지도\\광주.PNG");
				map_panel.repaint();
				map_panel.setVisible(true);
			}
		...
		btn_8.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				map_panel.setVisible(false);
				map_panel.setPath("C:\\Users\\SMHRD\\Desktop\\이미지\\지도\\울산.PNG");
				map_panel.repaint();
				map_panel.setVisible(true);
			}
		...
		btn_9.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				map_panel.setVisible(false);
				map_panel.setPath("C:\\Users\\SMHRD\\Desktop\\이미지\\지도\\부산.PNG");
				map_panel.repaint();
				map_panel.setVisible(true);
			}
		...
		btn_10.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				map_panel.setVisible(false);
				map_panel.setPath("C:\\Users\\SMHRD\\Desktop\\이미지\\지도\\강원.PNG");
				map_panel.repaint();
				map_panel.setVisible(true);
			}
		...
		btn_11.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				map_panel.setVisible(false);
				map_panel.setPath("C:\\Users\\SMHRD\\Desktop\\이미지\\지도\\충북.PNG");
				map_panel.repaint();
				map_panel.setVisible(true);
			}
		...
		btn_12.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				map_panel.setVisible(false);
				map_panel.setPath("C:\\Users\\SMHRD\\Desktop\\이미지\\지도\\충남.PNG");
				map_panel.repaint();
				map_panel.setVisible(true);
			}
		...
		btn_13.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				map_panel.setVisible(false);
				map_panel.setPath("C:\\Users\\SMHRD\\Desktop\\이미지\\지도\\경북.PNG");
				map_panel.repaint();
				map_panel.setVisible(true);
			}
		...
		btn_14.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				map_panel.setVisible(false);
				map_panel.setPath("C:\\Users\\SMHRD\\Desktop\\이미지\\지도\\경남.PNG");
				map_panel.repaint();
				map_panel.setVisible(true);
			}
		...
		btn_15.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				map_panel.setVisible(false);
				map_panel.setPath("C:\\Users\\SMHRD\\Desktop\\이미지\\지도\\전북.PNG");
				map_panel.repaint();
				map_panel.setVisible(true);
			}
		...
		btn_16.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				map_panel.setVisible(false);
				map_panel.setPath("C:\\Users\\SMHRD\\Desktop\\이미지\\지도\\전남.PNG");
				map_panel.repaint();
				map_panel.setVisible(true);
			}
		...
		btn_17.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				map_panel.setVisible(false);
				map_panel.setPath("C:\\Users\\SMHRD\\Desktop\\이미지\\지도\\제주.PNG");
				map_panel.repaint();
				map_panel.setVisible(true);
			}
