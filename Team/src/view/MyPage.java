...
public class MyPage {
	...
	public MyPage() {
		...
		lbl_username.setText(controller.select(pw).getName());
	...
	private void initialize() {
		...
		btn4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int result = JOptionPane.showConfirmDialog(null, "로그아웃 하시겠습니까?", "확인", JOptionPane.YES_NO_CANCEL_OPTION);
		...
		btn5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int result = JOptionPane.showConfirmDialog(null, "탈퇴 하시겠습니까?", "확인", JOptionPane.YES_NO_CANCEL_OPTION);
				if (result == JOptionPane.YES_OPTION) {
